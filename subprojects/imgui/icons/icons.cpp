...
bool ImGui::LoadInternalIcons(ImFontAtlas* atlas)
{
	...
	atlas->AddFontFromMemoryCompressedBase85TTF(kenney_compressed_data_base85, icons_size, &icons_config,
												ki_icons_ranges);
	...
	atlas->AddFontFromMemoryCompressedBase85TTF(fontaudio_compressed_data_base85, icons_size, &icons_config,
												fad_icons_ranges);

	static const ImWchar md_icons_ranges[] = {ICON_MIN_MD, ICON_MAX_16_MD, 0};
	atlas->AddFontFromMemoryCompressedBase85TTF(MaterialIcons_compressed_data_base85, icons_size, &icons_config,
												md_icons_ranges);
	...
	atlas->AddFontFromMemoryCompressedBase85TTF(fa_brands_compressed_data_base85, icons_size, &icons_config,
												fab_icons_ranges);
	icons_config.GlyphOffset.y = 1.0f * IM_FLOOR(icons_config.SizePixels / icons_size);	   // Add +1 offset per 16 units

	// Fork Awesome Icons
	static const ImWchar fk_icons_ranges[] = {ICON_MIN_FK, ICON_MAX_FK, 0};
	atlas->AddFontFromMemoryCompressedBase85TTF(fork_webfont_compressed_data_base85, icons_size, &icons_config,
												fk_icons_ranges);

	// StepMath
	static const ImWchar math_icons_ranges[] = {ICON_MIN_MATH, ICON_MAX_MATH, 0};
	atlas->AddFontFromMemoryCompressedBase85TTF(StepMath_compressed_data_base85, icons_size, &icons_config,
												math_icons_ranges);
